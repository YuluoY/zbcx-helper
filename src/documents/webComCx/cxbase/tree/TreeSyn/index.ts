...
class TreeSynDocument extends AttDocument {
  ...
  constructor() {
    const props: PropDoc[] = [
      {
        name: 'data',
        type: 'Array.<Object>',
        description: '树节点数据，树状结构，儿子结点用 children[]',
        values: [],
        default: ''
      },
      {
      ...
      },
      {
        name: 'tipConf',
        type: 'Object',
        description: 'tip配置，建element',
        values: [],
        default: '{effect: \'dark\', placement: \'right\'}'
      },
      {
        name: 'tipEllipsis',
        type: 'Function',
        description: '缩略文本函数，不缩略时返回空',
        values: [],
        default: ''
      },
      {
    ...
    const events: EventDoc[] = [
      ...
      },
      {
        name: 'check',
        description: '点击复选框',
        parameters: '(data, { checkedNodes, checkedKeys, halfcheckedNodes, halfcheckedKeys })'
      }
    ];
...
export default new TreeSynDocument(); 